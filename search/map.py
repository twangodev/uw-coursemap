...
from meeting_data_loader import MeetingDataLoader
...
class MapDataProcessor:
    ...
    def get_buildings_with_meeting_counts(self, meetings_data: List[Dict]) -> Tuple[geojson.FeatureCollection, Dict]:
        """
