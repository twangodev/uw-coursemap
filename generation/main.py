...
from cache import read_course_ref_to_course_cache, write_course_ref_to_course_cache, \
    ...
    write_quick_statistics_cache, read_quick_statistics_cache, write_explorer_extras_cache, read_explorer_extras_cache
...
def main():
    ...
    with logging_redirect_tqdm():
        ...
        if filter_step(step, "aggregate"):
            ...
            quick_statistics, explorer_extras = aggregate_courses(
                course_ref_to_course=course_ref_to_course,
            ...
            write_explorer_extras_cache(cache_dir, explorer_extras, logger)
        ...
        if not no_build:
            ...
            explorer_extras = read_explorer_extras_cache(cache_dir, logger)
            ...
            write_data(
                ...
                explorer_extras=explorer_extras,
                logger=logger
            )
