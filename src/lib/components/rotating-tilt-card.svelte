...
<div class="overflow-hidden -mt-16 mx-auto max-w-7xl lg:pr-44">
    <div class="perspective-distant -mr-16 pl-16 lg:-mr-56 lg:pl-56">
        <div class="[transform:rotateX(20deg);]">
            <div class="lg:h-176 relative skew-x-[.32rad]">
                ...
                <div aria-hidden="true" class="absolute -inset-16 bg-[linear-gradient(to_right,var(--color-border)_1px,transparent_1px),linear-gradient(to_bottom,var(--color-border)_1px,transparent_1px)] bg-[size:24px_24px] [--color-border:var(--color-zinc-600)] sm:-inset-32 dark:[--color-border:color-mix(in_oklab,var(--color-white)_20%,transparent)]"></div>
                <div aria-hidden="true" class="from-background z-11 absolute inset-0 bg-gradient-to-l"></div>
                ...
                <div aria-hidden="true" class="z-2 absolute inset-0 size-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,transparent_40%,var(--color-background)_100%)]"></div>
                {#key cardImages[i]}
                    <div class="z-1 relative mx-auto" transition:slide={slideParams}>
                        <img
